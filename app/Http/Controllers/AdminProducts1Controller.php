<?php namespace App\Http\Controllers;
	...
	class AdminProducts1Controller extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->col = [];
			$this->col[] = ["label"=>"Kategori Id","name"=>"kategori_id","join"=>"kategoris,name_kategori"];
			...
			$this->col[] = ["label"=>"Gambar1","name"=>"gambar1","image"=>true];
			$this->col[] = ["label"=>"Gambar2","name"=>"gambar2","image"=>true];
			# END COLUMNS DO NOT REMOVE THIS LINE

			# START FORM DO NOT REMOVE THIS LINE
			$this->form = [];
			$this->form[] = ['label'=>'Kategori Name','name'=>'kategori_id','type'=>'select2','validation'=>'required|min:1|max:255','width'=>'col-sm-10','datatable'=>'kategoris,name_kategori'];
