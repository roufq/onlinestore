<?php namespace App\Http\Controllers;
	...
	class AdminCheckoutController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->col = [];
			$this->col[] = ["label"=>"Nama Penerima","name"=>"fullname"];
			$this->col[] = ["label"=>"Nama Produk","name"=>"nama_barang"];
			...
			$this->form[] = ['label'=>'Nama Barang','name'=>'nama_barang','type'=>'text','validation'=>'required','width'=>'col-sm-9'];
			$this->form[] = ['label'=>'Tanggal','name'=>'created_at','type'=>'date','validation'=>'required','width'=>'col-sm-9'];
			...
			//$this->form[] = ['label'=>'Status','name'=>'status','type'=>'select','validation'=>'required|min:1|max:255','width'=>'col-sm-9','dataenum'=>'Not Yet Paid;Being Sent;Finished;Cancelled'];
			//$this->form[] = ['label'=>'Waktu Bayar','name'=>'waktu_bayar','type'=>'date','validation'=>'date','width'=>'col-sm-9'];
			//$this->form[] = ['label'=>'Bukti Pembayaran','name'=>'bukti_pembayaran','type'=>'upload','validation'=>'required|image','width'=>'col-sm-9'];
			# OLD END FORM
