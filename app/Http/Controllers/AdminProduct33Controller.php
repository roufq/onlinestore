<?php namespace App\Http\Controllers;
	...
	class AdminProduct33Controller extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->form[] = ['label'=>'Gambar1','name'=>'gambar1','type'=>'text','validation'=>'required|min:1|max:255','width'=>'col-sm-10'];
			$this->form[] = ['label'=>'Gambar2','name'=>'gambar2','type'=>'text','validation'=>'required|min:1|max:255','width'=>'col-sm-10'];
