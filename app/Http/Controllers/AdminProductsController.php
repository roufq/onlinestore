<?php namespace App\Http\Controllers;
	...
	class AdminProductsController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->col = [];
			$this->col[] = ["label"=>"Kategori Id","name"=>"kategori_id","join"=>"kategoris,id"];
			...
			$this->col[] = ["label"=>"Gambar1","name"=>"gambar1"];
			# END COLUMNS DO NOT REMOVE THIS LINE

			# START FORM DO NOT REMOVE THIS LINE
			$this->form = [];
			$this->form[] = ['label'=>'Kategori Id','name'=>'kategori_id','type'=>'select2','validation'=>'required|min:1|max:255','width'=>'col-sm-10','datatable'=>'kategoris,id'];
			...
			$this->form[] = ['label'=>'Berat','name'=>'berat','type'=>'number','validation'=>'required|min:1|max:255','width'=>'col-sm-10'];
			$this->form[] = ['label'=>'Gambar1','name'=>'gambar1','type'=>'upload','validation'=>'required|min:1|max:255','width'=>'col-sm-10'];
			$this->form[] = ['label'=>'Gambar2','name'=>'gambar2','type'=>'upload','validation'=>'required|min:1|max:255','width'=>'col-sm-10'];
			...
			//$this->form[] = ["label"=>"Gambar1","name"=>"gambar1","type"=>"text","required"=>TRUE,"validation"=>"required|min:1|max:255"];
			//$this->form[] = ["label"=>"Gambar2","name"=>"gambar2","type"=>"text","required"=>TRUE,"validation"=>"required|min:1|max:255"];
			# OLD END FORM
